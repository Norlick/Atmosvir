...
// -----------------------------------------------------------------------------
importScripts( 'Oimo.min.js' ); // Oimo DEV
// Switch to Cannon.js eventually?
// -----------------------------------------------------------------------------
...
function ActorBody( id, opt ) {
	...
	this.sc.belongsTo		= collide_actors;
	this.sc.collidesWith	= collide_all;
...
//	this.speed		= 0.2;
	...
	this.body = new OIMO.Body( {
		name	: 'actor',
	//	type	: 'cylinder', // Only supported in Oimo.js REV
		type	: 'sphere',
